...
<div id="main">
	...
	<div id="answers">
		<p id="wort"><?php echo $word ?></p>
		<p id="artikel">???</p>
	</div>
	<!--<div id="germanButton" onclick="generatePractice()"><p id="uben">Üben</p></div>-->
	<form action="index.php" method="POST">
		<input type="submit" value ="Üben" id="germanButton"><p id="uben">Üben</p></input>
	</form>
	
	<div id="level">
		<table id="levelTable">
			<tr>
				<td id="tdMeanings" onclick="meanings()">
					<p>Meanings</p>
				</td>
				<td id="tdArticles" onclick="articles()">
					<p>Articles</p>
				</td>
				<td id="tdBoth" onclick="both()">
					<p>Both</p>
				</td>
			</tr>
		</table>
...
<script type="text/javascript">
	function meanings() {
		document.getElementById('tdMeanings').style.backgroundColor = "#39A2AE";
		document.getElementById('tdArticles').style.backgroundColor = "#328E99";
		document.getElementById('tdBoth').style.backgroundColor = "#328E99";
	}
	function articles() {
		document.getElementById('tdArticles').style.backgroundColor = "#39A2AE";
		document.getElementById('tdMeanings').style.backgroundColor = "#328E99";
		document.getElementById('tdBoth').style.backgroundColor = "#328E99";
	}
	function both() {
		document.getElementById('tdBoth').style.backgroundColor = "#39A2AE";
		document.getElementById('tdArticles').style.backgroundColor = "#328E99";
		document.getElementById('tdMeanings').style.backgroundColor = "#328E99";
	}
</script>
